/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc --config=../api/wrangler.jsonc --env-interface=CloudflareBindings` (hash: ab1ac3f1ba92f345b310ff11b8452947)
// Runtime types generated with workerd@1.20260708.1 2025-09-02 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	VITE_PUBLIC_URL: string;
	VITE_API_URL: string;
	API: Service<typeof import("../api/src/index").FrontendEntrypoint>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_PUBLIC_URL" | "VITE_API_URL">> {}
}
