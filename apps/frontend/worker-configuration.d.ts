/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc --config=../api/wrangler.jsonc --env-interface=CloudflareBindings` (hash: da96d86ba714a7042331d772c2c828d8)
