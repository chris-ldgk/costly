/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 791b45afda47f8e88517fb1c30d3d954)
// Runtime types generated with workerd@1.20260708.1 2026-07-09 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: Hyperdrive;
	COSTLY_DB_POSTGRES?: Fetcher;
	COSTLY_DB?: Fetcher;
	CORS_ORIGINS: "https://costly-frontend.stizzle.workers.dev" | "http://localhost:3000";
	BETTER_AUTH_URL: "https://costly-frontend.stizzle.workers.dev" | "http://localhost:8787";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGINS" | "BETTER_AUTH_URL" | "ALLOWED_USERS" | "NODE_ENV" | "BETTER_AUTH_SECRET" | "DATABASE_URL">> {}
}
